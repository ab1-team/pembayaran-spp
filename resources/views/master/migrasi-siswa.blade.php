...
<body class="min-h-screen text-slate-800">
    ...
    <main class="mx-auto max-w-3xl px-4 py-6 sm:px-6 sm:py-8">
        <header class="mb-6">
            ...
            <h2 class="mt-1 text-2xl font-bold text-slate-900">Migrasi Siswa Baru</h2>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div class="mt-5 flex justify-end gap-2">
                <button id="btn-reset" type="button" class="rounded-lg border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50">Reset</button>
                <button id="btn-import" type="button" class="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-5 py-2 text-xs font-semibold text-white shadow-sm hover:bg-indigo-700 disabled:opacity-50">
    ...
    <script>
        ...
        btnImport.addEventListener('click', function () {
            ...
            fetch('{{ route('master.migrasi.siswa') }}', {
                method: 'POST',
                body: formData,
