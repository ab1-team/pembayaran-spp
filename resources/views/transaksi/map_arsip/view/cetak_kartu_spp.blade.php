...
.style1 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 18px; text-align:center; font-weight: bold;}
...
<body onload="window.print()">
	...
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
		...
		@if (!empty($logo))
			<img src="data:image/{{ $logo_type }};base64,{{ $logo }}" style="width:60px; float:left;"/><br>
		@endif
		<div class="style27">
...
<div class="style1 top bottom">KARTU SPP</div>
	...
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
            ...
            <tr>
              <th height="29" class="style9 top left bottom"><p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              ...
              <th class="style9 left top bottom"><p>&nbsp;</p></th>
              <th class="style9 left top bottom"><p>&nbsp;</p></th>
              <th class="style9 left top bottom right"><p>&nbsp;</p></th>
            </tr>
	</table>
